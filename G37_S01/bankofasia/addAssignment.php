    ...
    if(isset($_POST["submit"])){
        ...
        if(mysqli_query($conn, $sql)){
            ...
            if($government_flag == 1 and !(empty($_POST["ministry_code"]))){
                ...
                $ministries = explode(",", $ministry_code);
                for($x = 0; $x < count($ministries); $x++){
                    $sql = "INSERT INTO ministry_assignment VALUES('$ministries[$x]', '$last_id')";
                    if(!mysqli_query($conn, $sql)){
                ...
                <div class="card-body">
                    <form action="addAssignment.php" method="POST">
                        ...
                        <div id="government">
                            ...
                            <div class="form-group">
                                <label for="ministry_code">Ministry Code(Enter ministry codes seperated by commas Eg: 1,2)</label>
