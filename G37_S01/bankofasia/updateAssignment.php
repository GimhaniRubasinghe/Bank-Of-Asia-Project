                ...
                <table id="table_id" class="table table-striped">
                    ...
                    <?php foreach ($assignments as $assignment) { ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($assignment["internal_flag"]);?></td>
                            <td><?php echo htmlspecialchars($assignment["government_flag"]);?></td>
                            <td><?php echo htmlspecialchars($assignment["thirdparty_flag"]);?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
